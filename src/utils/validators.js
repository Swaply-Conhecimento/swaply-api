...
const userValidators = {
  updateProfile: [
    ...
    body('bio')
      ...
      .withMessage(`Bio não pode ter mais de ${SYSTEM_LIMITS.MAX_USER_BIO_LENGTH} caracteres`),
    
    body('skills')
      .optional()
      .isArray({ max: SYSTEM_LIMITS.MAX_SKILLS_PER_USER })
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_SKILLS_PER_USER} habilidades permitidas`),
  ...
  updateSettings: [
    body('theme')
      ...
      .withMessage(`Tema deve ser um dos valores: ${Object.values(THEME_OPTIONS).join(', ')}`),
    
    body('fontSize')
      .optional()
      .isIn(Object.values(FONT_SIZES))
      .withMessage(`Tamanho da fonte deve ser um dos valores: ${Object.values(FONT_SIZES).join(', ')}`),
...
const courseValidators = {
  create: [
    body('title')
      ...
      .withMessage(`Título deve ter entre 5 e ${SYSTEM_LIMITS.MAX_COURSE_TITLE_LENGTH} caracteres`),
    ...
    body('description')
      ...
      .withMessage(`Descrição deve ter entre 20 e ${SYSTEM_LIMITS.MAX_COURSE_DESCRIPTION_LENGTH} caracteres`),
    
    body('category')
      .notEmpty()
      .withMessage('Categoria é obrigatória')
      .isIn(COURSE_CATEGORIES)
      .withMessage(`Categoria deve ser uma das opções: ${COURSE_CATEGORIES.join(', ')}`),
    
    body('level')
      .notEmpty()
      .withMessage('Nível é obrigatório')
      .isIn(Object.values(COURSE_LEVELS))
      .withMessage(`Nível deve ser um dos valores: ${Object.values(COURSE_LEVELS).join(', ')}`),
    
    body('language')
      .optional()
      .isIn(SUPPORTED_LANGUAGES)
      .withMessage(`Idioma deve ser um dos valores: ${SUPPORTED_LANGUAGES.join(', ')}`),
    
    body('pricePerHour')
      .isInt({ min: SYSTEM_LIMITS.MIN_COURSE_PRICE, max: SYSTEM_LIMITS.MAX_COURSE_PRICE })
      .withMessage(`Preço por hora deve ser entre ${SYSTEM_LIMITS.MIN_COURSE_PRICE} e ${SYSTEM_LIMITS.MAX_COURSE_PRICE} créditos`),
    
    body('totalHours')
      .isInt({ min: SYSTEM_LIMITS.MIN_COURSE_HOURS, max: SYSTEM_LIMITS.MAX_COURSE_HOURS })
      .withMessage(`Total de horas deve ser entre ${SYSTEM_LIMITS.MIN_COURSE_HOURS} e ${SYSTEM_LIMITS.MAX_COURSE_HOURS} horas`),
    ...
    body('features')
      ...
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_FEATURES_PER_COURSE} características permitidas`),
    ...
    body('requirements')
      ...
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_REQUIREMENTS_PER_COURSE} requisitos permitidos`),
    ...
    body('objectives')
      ...
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_OBJECTIVES_PER_COURSE} objetivos permitidos`),
    ...
    body('curriculum')
      ...
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_CURRICULUM_ITEMS} itens no currículo`),
    ...
    body('schedule')
      ...
      .withMessage(`Máximo de ${SYSTEM_LIMITS.MAX_SCHEDULE_SLOTS} horários permitidos`),
...
const classValidators = {
  schedule: [
    ...
    body('duration')
      .optional()
      .isFloat({ min: SYSTEM_LIMITS.MIN_CLASS_DURATION, max: SYSTEM_LIMITS.MAX_CLASS_DURATION })
      .withMessage(`Duração deve ser entre ${SYSTEM_LIMITS.MIN_CLASS_DURATION} e ${SYSTEM_LIMITS.MAX_CLASS_DURATION} horas`),
  ...
  update: [
    ...
    body('notes')
      ...
      .withMessage(`Notas não podem ter mais de ${SYSTEM_LIMITS.MAX_CLASS_NOTES_LENGTH} caracteres`)
  ]
};
...
const reviewValidators = {
  create: [
    ...
    body('comment')
      ...
      .withMessage(`Comentário não pode ter mais de ${SYSTEM_LIMITS.MAX_REVIEW_COMMENT_LENGTH} caracteres`),
...
const paymentValidators = {
  purchaseCredits: [
    body('credits')
      .isInt({ min: SYSTEM_LIMITS.MIN_CREDITS_PURCHASE, max: SYSTEM_LIMITS.MAX_CREDITS_PURCHASE })
      .withMessage(`Quantidade de créditos deve ser entre ${SYSTEM_LIMITS.MIN_CREDITS_PURCHASE} e ${SYSTEM_LIMITS.MAX_CREDITS_PURCHASE}`),
...
const paramValidators = {
  ...
  reviewId: param('reviewId').isMongoId().withMessage('ID da avaliação inválido'),
  notificationId: param('notificationId').isMongoId().withMessage('ID da notificação inválido')
};
